...
`pd_title` varchar(255) NOT NULL DEFAULT '' COMMENT 'Title for donation item.',
`pd_description` text NOT NULL COMMENT 'Description for donation item.',
...
`pda_donation` int(11) NOT NULL DEFAULT '0' COMMENT 'Donation item ID from paypal_donation table.',
`pda_label` varchar(255) NOT NULL DEFAULT '' COMMENT 'Label for donation amount item.',
`pda_value` float NOT NULL DEFAULT '0' COMMENT 'Value for donation amount item.',
PRIMARY KEY (`pda_id`)/*,*/
